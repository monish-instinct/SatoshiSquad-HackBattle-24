...
const currentSong = {
  ...
  cover: "https://rnwvfxlxmvvmzgbcbqbr.supabase.co/storage/v1/object/public/images/album-cover-neon-dreams.jpg",
...
export function ListenPage() {
  ...
  return (
    (<div
      className="min-h-screen bg-gradient-to-b from-background to-secondary p-6 md:p-12">
